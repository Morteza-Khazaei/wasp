...
def main():
    ...
    parser.add_argument("--verbose", help="Verbose output of the processing. Default is False", default="False", type=str)
    ...
    parser.add_argument("-r", "--removeTemp", help="Removes the temporary created files after use. Default is true", required=False, default="False", type=str)
    parser.add_argument("--cog", help="Write the product conform to the CloudOptimized-Geotiff format. Default is false", required=False, default="False", type=str)
    ...
    parser.add_argument("-l", "--lightmode", help="Light mode, process Sentinel 2 with a resolution of 60m. Default is False", required=False, default="False", type=str)
    ...
    parser.add_argument("--writedts", help="Write DTS mask (only in lightmode)", required=False, default="False", type=str)
